...
public class MainController {
    ...
    public Object postBalances(@RequestBody RequestDTO requestDTO) {
        ...
        try {
            ...
            log.error(
                    "***** RequestDTO *****" + mapper.writerWithDefaultPrettyPrinter().writeValueAsString(requestDTO));
            log.error(
                    "***** ResponseDTO *****" + mapper.writerWithDefaultPrettyPrinter().writeValueAsString(responseDTO));
